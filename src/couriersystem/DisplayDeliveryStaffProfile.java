 ...
 * @author jeera
 */
public class DisplayDeliveryStaffProfile extends javax.swing.JFrame {
     ...
     */
    public DisplayDeliveryStaffProfile(String id, boolean allowEdit) {
        initComponents();
        ...
        try{
            ...
            File myFile = new File(GlobalConfig.dbPath + "DeliveryStaff.txt");
            ...
            while(sc.hasNext()){
                ...
                if (tempArr[0].equals(id)){
                    DeliveryStaff deliveryStaff = new DeliveryStaff(id,tempArr[1],tempArr[2],tempArr[3],tempArr[4],tempArr[5],tempArr[6], tempArr[7]);
                    
                    // Display Profile Info
                    txtID.setText(deliveryStaff.getId());
                    txtName.setText(deliveryStaff.getName());
                    if (deliveryStaff.getGender().equals("Male")){
                        rbMale.setSelected(true);    
                    } else {
                        rbFemale.setSelected(true);    
                    }
                    try{
                        if (!deliveryStaff.getDateOfBirth().isBlank()){
                            Date dobb = dateFormat.parse(deliveryStaff.getDateOfBirth());
                            dpDOB.setDate(dobb);
                        }
                    } catch (Exception e){
                        dpDOB.setDate(null); 
                    }
                    txtContact.setText(deliveryStaff.getContactNo());
                    txtEmail.setText(deliveryStaff.getEmail());
                    imgPath = deliveryStaff.getImgUrl();
                    ...
                    txtCompany.setText(deliveryStaff.getCompany());
                }
            }
            sc.close();
        }
    ...
    private void initComponents() {
        ...
        jLabel12.setText("Delivery Staff Information");
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addComponent(profileImg, javax.swing.GroupLayout.PREFERRED_SIZE, 112, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(btnImage)
                .addGap(36, 36, 36)
    ...
    private DeliveryStaff setupProfile(){
        DeliveryStaff profile = new DeliveryStaff(
                id, 
                txtName.getText(),
                gender,
    ...
    private void btnConfirmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmActionPerformed
        ...
        File curFile = new File(GlobalConfig.dbPath + "DeliveryStaff.txt");
        ...
        try{
            ...
            while(sc.hasNext())
            {
                ...
                if(values[0].equals(id)){
                    DeliveryStaff deliveryStaff = setupProfile();
                    pw.println(deliveryStaff.toOneLineString());
                } else {
                    pw.println(row);
                }
            }
        ...
        File n = new File(GlobalConfig.dbPath + "DeliveryStaff.txt");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DisplayDeliveryStaffProfile.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
